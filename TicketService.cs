...
public class TicketService
{
    ...
    private async Task InteractionCreatedAsync(SocketInteraction interaction)
    {
        ...
        {
            if (slashCommand.CommandName == "ticket" && slashCommand.Data.Options.FirstOrDefault()?.Name == "close")
            {
    ...
    public async Task CloseTicketAsync(SocketSlashCommand command)
    {
        ...
        // Optionally check if user is ticket creator or has support role here
