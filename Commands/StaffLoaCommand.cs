...
public class StaffLoaCommand : ISlashCommand
{
    ...
    private static readonly Dictionary<string, (ulong ChannelId, ulong ApproverRoleId, string Label)> DivisionRoutes =
        new()
        {
            ["police_response_staff"] = (1394453949553184909, 1394649657644290078, "Police Response Staff"),
            ["police_roads_staff"]    = (1394453949553184909, 1394649657644290078, "Police Roads Staff"),
            ["police_firearms_staff"] = (1394453949553184909, 1394649657644290078, "Police Firearms Staff"),
            ["police_senior_command"] = (1394453949553184909, 1394458024503935006, "Police Senior Command"),
